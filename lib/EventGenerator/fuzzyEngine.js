...
var FuzzyEngine = function(){
	...
	this.fuzzifier = new Fuzzifier(this.memfuncs,this.vars );
...
FuzzyEngine.prototype.run = function(variables,randNum)
{
	...
	var NonZeroVars = GetNonZeroVariables(this.vars,varVals);
...
function GetNonZeroVariables(varArragment,varVals){
